...
RUN set -x \
  && /ocamt-pinned/bin/pip install --no-cache-dir -e git+https://github.com/sygel-technology/maintainer-tools.git@4be6e22c1304f3baebba01f7645e855aaa517f7a#egg=oca-maintainers-tools \
...
RUN set -x \
  && /ocamt/bin/pip install --no-cache-dir -e git+https://github.com/sygel-technology/maintainer-tools.git@4be6e22c1304f3baebba01f7645e855aaa517f7a#egg=oca-maintainers-tools \
